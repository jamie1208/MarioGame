...
public class StartPanel extends Canvas implements Runnable{
	...
	public StartPanel(String[] randomEnemy){
        try {
    ...
    public void run(){
        ...
        Game2.game2Panel = new Game2Panel(randomEnemy);
        Game2.game2Thread = new Thread(Game2.game2Panel);	
        Game2.game2Thread.start();
        Game2.frame.add(Game2.game2Panel);
